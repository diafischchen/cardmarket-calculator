<nav>
    <ul>
        <li>Karteninventar</li>
    </ul>
    <ul>
        <li><a href="#" class="secondary"><i class="fa fa-th-list" aria-hidden="true"></i></a></li>
        <li><a href="#" class="secondary"><i class="fa fa-th-large" aria-hidden="true"></i></a></li>
    </ul>
</nav>
